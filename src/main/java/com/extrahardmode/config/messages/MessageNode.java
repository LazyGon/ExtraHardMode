...
public enum MessageNode implements ConfigNode {
    /**
     * Display messages from extrahardmode in the scoreboard instead of spamming the
     * chat?
     */
     ...
     * chat?
     */
    SB_MSG_TITLE("Display Messages In Scoreboard.Scoreboard Title", VarType.STRING, SubType.PLAYER_NAME,
            "&cExtraHardMode"),
    /**
     * Display messages from extrahardmode in the scoreboard instead of spamming the
     * chat?
     ...
     * chat?
     */
    SB_MSG_NOTIFICATION_LEN("Display Messages In Scoreboard.Notification.Displaytime In Ticks", VarType.INTEGER,
            600),
    /**
     * Display messages from extrahardmode in the scoreboard instead of spamming the
     * chat?
    ...
    NO_TORCHES_HERE("NoTorchesHere.Msg", MsgCategory.NOTIFICATION, "torches_underground",
    ...
    STONE_MINING_HELP("StoneMiningHelp.Msg", MsgCategory.NOTIFICATION, "hardened_stone",
    ...
    NO_PLACING_ORE_AGAINST_STONE("NoPlacingOreAgainstStone.Msg", MsgCategory.NOTIFICATION, "hardened_stone_ore",
            "Sorry, you can't place ore next to stone."),
    REALISTIC_BUILDING_MODE("RealisticBuilding.Mode", MsgCategory.NOTIFICATION),
    REALISTIC_BUILDING("RealisticBuilding.Msg", MsgCategory.NOTIFICATION, "realistic_building",
            "You can't build while in the air."),
    REALISTIC_BUILDING_BENEATH_MODE("RealisticBuildingBeneath.Mode", MsgCategory.NOTIFICATION),
    REALISTIC_BUILDING_BENEATH("RealisticBuildingBeneath.Msg", MsgCategory.NOTIFICATION,
    ...
    LIMITED_TORCH_PLACEMENTS("LimitedTorchPlacements.Msg", MsgCategory.NOTIFICATION, "torches_soft_blocks",
            "It's too soft there to fasten a torch."),
    NO_CRAFTING_MELON_SEEDS_MODE("NoCraftingMelonSeeds.Mode", MsgCategory.NOTIFICATION),
    NO_CRAFTING_MELON_SEEDS("NoCraftingMelonSeeds.Msg", MsgCategory.NOTIFICATION, "no_crafting_melon_seeds",
            "That appears to be seedless!"),
    LIMITED_END_BUILDING_MODE("LimitedEndBuilding.Mode", MsgCategory.NOTIFICATION),
    LIMITED_END_BUILDING("LimitedEndBuilding.Msg", MsgCategory.NOTIFICATION, "limited_building_end",
    ...
    DRAGON_FOUNTAIN_TIP("DragonFountainTip.Msg", MsgCategory.NOTIFICATION, "dragon_fountain_tip",
    ...
    NO_SWIMMING_IN_ARMOR("NoSwimmingInArmor.Msg", MsgCategory.NOTIFICATION, "no_swimming_in_armor_warning",
            "You're carrying too much weight to swim!"),
    END_DRAGON_KILLED_MODE("DragonDefeated.Mode", MsgCategory.BROADCAST),
    END_DRAGON_KILLED("DragonDefeated.Msg", MsgCategory.BROADCAST, "end_dragon_killed",
    ...
    END_DRAGON_PLAYER_KILLED("PlayerKilledByDragon.Msg", MsgCategory.BROADCAST, "player_killed_dragon",
    ...
    END_DRAGON_PLAYER_CHALLENGING("PlayerChallengingDragon.Msg", MsgCategory.BROADCAST, "player_challenging_dragon",
            Variables.PLAYER.getVarName() + " is challenging the dragon!"),

    // Horses
    HORSE_FEED_LOW_MODE("HorseFeedLow.Mode", MsgCategory.NOTIFICATION),
    HORSE_FEED_LOW("HorseFeedLow.Msg", MsgCategory.NOTIFICATION, "horse_feed_low",
    ...
    HORSE_FEED_MIDDLE("HorseFeedMiddle.Msg", MsgCategory.NOTIFICATION, "horse_feed_middle",
            "Your horse has ate well."),
    HORSE_FEED_HIGH_MODE("HorseFeedHigh.Mode", MsgCategory.NOTIFICATION),
    HORSE_FEED_HIGH("HorseFeedHigh.Msg", MsgCategory.NOTIFICATION, "horse_feed_high",
            "Your horse is satiated."),

    HORSE_STARVING_LOW_MODE("HorseStarveLow.Mode", MsgCategory.NOTIFICATION),
    HORSE_STARVING_LOW("HorseStarveLow.Msg", MsgCategory.NOTIFICATION, "horse_starve_low",
    ...
    HORSE_STARVING_DANGEROUS("HorseStarveMiddle.Msg", MsgCategory.NOTIFICATION, "horse_starve_dangerous",
            "Your horse is about to starve."),
    HORSE_STARVING_IMMINENT_DEATH_MODE("HorseStarveHigh.Mode", MsgCategory.NOTIFICATION),
    HORSE_STARVING_IMMINENT_DEATH("HorseStarveHigh.Msg", MsgCategory.NOTIFICATION, "horse_starve_imminent_death",
            "Your horse is starving, feed it or it will die."),

    // Target Events
    CHARGED_CREEPER_TARGET_MODE("ChargedCreeper.Mode", MsgCategory.TUTORIAL),
    CHARGED_CREEPER_TARGET("ChargedCreeper.Msg", MsgCategory.TUTORIAL, "charged_creeper",
            "Charged Creepers explode instantly when hit. Run!"),
    BLAZE_TARGET_NORMAL_MODE("BlazeOverworld.Mode", MsgCategory.TUTORIAL),
    BLAZE_TARGET_NORMAL("BlazeOverworld.Msg", MsgCategory.TUTORIAL, "blaze_overworld",
    ...
    ANTIFARMING_UNWATERD("AntifarmingUnwatered.Msg", MsgCategory.TUTORIAL, "antifarm_unwatered",
    ...
    @Override
    public Object getValueToDisable() { /* ignored */
        return null;
    }
