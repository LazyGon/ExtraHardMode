...
// @PrepareForTest({MultiWorldConfig.class, JavaPlugin.class,
// PluginLogger.class}) //Breaks in JDK 11 apparently
public class TestMultiWorldConfig {
    ...
    // /**
    // * Test if normal retrieval of nodes which are present int the config is
    // possible
    // */
    // @Test
    ...
    // false).getStatusCode() == Status.OK);
    //
    // assertEquals(4, module.loadNode(config, MockConfigNode.INT_0,
    // false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.INT_0,
    // false).getStatusCode() == Status.OK);
    //
    // assertEquals(9, module.loadNode(config, MockConfigNode.INT_9,
    // false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.INT_0,
    // false).getStatusCode() == Status.OK);
    //
    // assertEquals(Mode.INHERIT.name(), (String) module.loadNode(config,
    // MockConfigNode.STR_0, false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.STR_0,
    // false).getStatusCode() == Status.INHERITS);
    // }
    //
    //
    // /**
    // * Make sure that when a node is not found in the config that we get the
    // default value back (not null). and that the
    // * Status is NOT_FOUND
    // */
    // @Test
    // public void testLoadNodeNotFound()
    // {
    // assertEquals(MockConfigNode.NOTFOUND_BOOL.getDefaultValue(),
    // module.loadNode(config, MockConfigNode.NOTFOUND_BOOL, false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.NOTFOUND_BOOL,
    // false).getStatusCode() == Status.NOT_FOUND);
    //
    // assertEquals(MockConfigNode.NOTFOUND_DOUBLE.getDefaultValue(),
    // module.loadNode(config, MockConfigNode.NOTFOUND_DOUBLE, false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.NOTFOUND_DOUBLE,
    // false).getStatusCode() == Status.NOT_FOUND);
    //
    // assertEquals(MockConfigNode.NOTFOUND_INT.getDefaultValue(),
    // module.loadNode(config, MockConfigNode.NOTFOUND_INT, false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.NOTFOUND_INT,
    // false).getStatusCode() == Status.NOT_FOUND);
    //
    // assertEquals(MockConfigNode.NOTFOUND_STR.getDefaultValue(),
    // module.loadNode(config, MockConfigNode.NOTFOUND_STR, false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.NOTFOUND_STR,
    // false).getStatusCode() == Status.NOT_FOUND);
    //
    // assertEquals(MockConfigNode.NOTFOUND_LIST.getDefaultValue(),
    // module.loadNode(config, MockConfigNode.NOTFOUND_LIST, false).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.NOTFOUND_LIST,
    // false).getStatusCode() == Status.NOT_FOUND);
    //
    //
    // assertTrue(module.loadNode(config, MockConfigNode.NOTFOUND_BOOL,
    ...
    //
    // assertEquals(1, module.loadNode(config, MockConfigNode.NOTFOUND_INT,
    // true).getContent());
    // assertTrue(module.loadNode(config, MockConfigNode.NOTFOUND_INT,
    // true).getStatusCode() == Status.ADJUSTED);
    //
    ...
    //
    // /**
    // * Make sure that the Status returned is Status.INHERITS for all nodes with
    // "inherit" as value and that "inherit" is
    ...
    // assertEquals(Mode.INHERIT.name(), response.getContent()); //only for strings
    ...
    //
    // /**
    // * Test the customBounds method through the health subtype Allowed values are
    // 1-20
    // */
    // @Test
