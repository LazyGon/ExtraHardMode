...
// {
// coreProtectAPI.logRemoval(fallingBlockFallTag, block.getLocation(),
...
// {
// coreProtectAPI.logPlacement(fallingBlockLandTag, block.getLocation(),
// block.getTypeId(), block.getData().getData());
// }
//
//
// @Override
...
// {
// Plugin coreProtect =
// plugin.getServer().getPluginManager().getPlugin("CoreProtect");
//
