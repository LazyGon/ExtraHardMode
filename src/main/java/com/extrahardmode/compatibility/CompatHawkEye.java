...
// hawkEyeEnabled =
// plugin.getServer().getPluginManager().isPluginEnabled("HawkEye");
// }
//
//
// @Override
...
// {
// HawkEyeAPI.addEntry(plugin, new BlockEntry(fallingBlockFallTag,
...
// String before = block.getRawData() != 0 ? block.getTypeId() + ":" +
// block.getRawData() : Integer.toString(block.getTypeId());
// HawkEyeAPI.addEntry(plugin, new BlockChangeEntry(fallingBlockLandTag,
// DataType.BLOCK_PLACE, block.getLocation(), before, after));
// }
//
//
// @Override
