...
public class TestBlockItemMetaParser {
    ...
    //
    // assertTrue("Basic data retrival",
    // retrievedData.getContent().containsKey(Material.ANVIL.getId()));
    // assertEquals("No data inserted so we should get no data back",
    // Collections.<Byte>emptyList(),
    // retrievedData.getContent().get(Material.ANVIL.getId()));
    // assertSame("Nothing has been adjusted", retrievedData.getStatusCode(),
    // Status.OK);
    //
    // assertTrue("Basic Data retrival",
    // retrievedData.getContent().containsKey(Material.COBBLESTONE.getId()));
    // assertEquals("No data inserted so we should get no data back",
    // Collections.<Byte>emptyList(),
    // retrievedData.getContent().get(Material.ANVIL.getId()));
    // }
    ...
    // SpecialParsers.parseMaterials(fallingBlocks);
    //
    // assertTrue("Will the String be trimmed and still get recognixed",
    // retrievedData.getContent().containsKey(34));
    // assertEquals("No data inserted", Collections.<Byte>emptyList(),
    // retrievedData.getContent().get(34));
    // Assert.assertSame("Our value has been adjusted",
    // retrievedData.getStatusCode(), Status.NEEDS_TO_BE_ADJUSTED);
    // }
    //
    //
    // /**
    ...
    //
    // assertEquals(Collections.<Byte>emptyList(),
    // retrievedData.getContent().get(Material.ANVIL.getId()));
    // assertEquals(Collections.<Byte>emptyList(),
    // retrievedData.getContent().get(Material.BEACON.getId()));
    //
    // assertSame("Nothing has been adjusted", retrievedData.getStatusCode(),
    // Status.OK);
    // }
    ...
    // SpecialParsers.parseMaterials(fallingBlocks);
    //
    // assertTrue("Keep blockids for mod compatibility",
    // retrievedData.getContent().containsKey(1200));
    //
    // assertSame("Keep blockids for mod compatibility",
    // retrievedData.getStatusCode(), Status.OK);
    // }
    //
    //
    // /**
    ...
    // SpecialParsers.parseMaterials(fallingBlocks);
    //
    // assertEquals((byte) Byte.MAX_VALUE, (byte)
    // retrievedData.getContent().get(1200).get(0));
    //
    // assertSame("Keep blockids for mod compatibility",
    // retrievedData.getStatusCode(), Status.NEEDS_TO_BE_ADJUSTED);
    // }
    ...
    //
    // assertEquals("blockname@meta1,meta2,meta3 is the expected format",
    // "SAND@1,2,3", outPutStrings.get(0));
    // }
    //
    //
    // /**
