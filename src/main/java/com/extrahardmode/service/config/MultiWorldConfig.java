...
public abstract class MultiWorldConfig extends EHMModule {
    ...
    /**
     * For mods like MystCraft which allow Players to create their own dimensions,
     * so the admin doesn't have to add worlds manually
     */
    ...
    // /__\ __ __ _| |__ | | ___ __| | (_)_ __ __ _| | | / / /\ \ \___ _ __| | __|
    // |___
    // /_\| '_ \ / _` | '_ \| |/ _ \/ _` | | | '_ \ / _` | | | \ \/ \/ / _ \| '__|
    // |/ _` / __|
    // //__| | | | (_| | |_) | | __/ (_| | | | | | | | (_| | | | \ /\ / (_) | | | |
    // (_| \__ \
    // \__/|_| |_|\__,_|_.__/|_|\___|\__,_| |_|_| |_| \__,_|_|_| \/ \/ \___/|_|
    // |_|\__,_|___/
    //
