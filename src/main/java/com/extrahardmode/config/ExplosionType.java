...
/**
 * Holds all the properties for the custom explosions, handles the configuration
 * aswell
 */
public enum ExplosionType {
    /**
     * yLevel, powerBelow, powerAbove, fireBelow, fireAbove, allowBlockDamageBelow,
     * allowBlockDamageAbove
     **/
